...
const DESIGN_TOKENS = {
  layout: { sidebar: { width: { collapsed: '60px', expanded: '200px' }, header: { height: '60px' } },
  animation: { duration: { normal: 300 }, easing: { default: 'ease-in-out' } }
};
const MOTION_PRESETS = { fadeIn: { initial: { opacity: 0 }, animate: { opacity: 1 }, transition: { duration: 0.2 } }, buttonHover: { whileHover: { scale: 1.05 } } };
